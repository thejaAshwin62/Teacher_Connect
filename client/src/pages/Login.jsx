...
export default function Login() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-b from-blue-50 to-blue-100 pt-16">
      <div className="w-full max-w-md p-8 space-y-8 bg-white rounded-xl shadow-2xl mx-4">
        {/* Tabs */}
